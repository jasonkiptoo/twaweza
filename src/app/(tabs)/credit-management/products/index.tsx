...
export default function ProductsScreen() {
  ...
  const { products, loading, error, refresh, hasMore, loadMore } = useLoanProducts(true);
  ...
  return (
    <Screen>
      ...
      <VStack className="gap-4">
        ...
        {hasMore && (
          <AppButton title="Load more products" loading={loading} onPress={loadMore} variant="outline" />
        )}
        <AppButton
          title="Back to loans"
          variant="ghost"
